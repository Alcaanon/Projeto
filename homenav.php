    ...
    <div class="container px-5">
        <a class="navbar-brand" href="home.php">Start Bootstrap</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                ...
                <li><a class="dropdown-item" a href="blog.form" >Blogs</a></li>
                <li><a class="dropdown-item" a href="categoria.form" >Categorias</a></li>
                <li><a class="dropdown-item" a href="servico.form" >Serviços</a></li>
                <li><a class="dropdown-item" a href="register" >Usuários</a></li>
                <li><hr class="dropdown-divider"></li>
