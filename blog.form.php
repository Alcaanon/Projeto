                    ...
                    <div class="col-7">
                        <form id="blogform" action="blog.register" method="post">
                            <div class="form-group">
                                <label for="idClasse">Nome da classe</label>
                                <input type="text" id="idClasse" name="inputClasse" class="form-control" value="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="descricao">Nome do Autor do blog</label>
                                <input type="text" step="any" id="nome" name="inputNome"  class="form-control" value="">
                            </div>
                            <div class="form-group">
                                <label for="descricao">Data de publicação do blog</label>
                                <input type="text" step="any" id="data" name="inputData"  class="form-control" value="">
                            </div>
                            <div class="form-group">
